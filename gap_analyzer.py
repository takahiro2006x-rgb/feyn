...
def build_analysis_prompt(subject, difficulty, transcript_rows):
...
def analyze_session(client, models, subject, difficulty, transcript_rows):
    ...
    prompt = build_analysis_prompt(subject, difficulty, transcript_rows)
